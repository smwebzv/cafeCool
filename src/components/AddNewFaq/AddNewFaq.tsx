...
const AddNewFaq = () => {
  ...
  const [numberFaqs, setNumberFaqs] = useState<any>({});
  ...
  const handleChange = (e:any, indx:number) => {
      ...
      <FakFrame>
        ...
        <FakBox>
          ...
          <table>
            ...
            <tbody>
              {dailyList.map((item1:any, indx1:any) => (
                <tr key={indx1}>
                  <td>{indx1 + 1}.</td>
                  <td>
                    <select
